				...
				<div class="content-wrapper">
					<div class="card">
						<div class="card-header"
									...
									<h4 class="text-white m-0">View Account Type</h4>
								</div>
						<div class="card-body">
								...
								<div class="col-12">
									<div class="table-responsive">
										<table id="order-listing" class="table">
											...
											<c:forEach var="i" items="${searchAccountTypeList}" varStatus="j">
												<tr>
													<td>${j.count}</td>
													<td>${i.accountType}</td>
													<td>${i.accountDescription}</td>
													<td>
														<a href="editAccountType?id=${i.accountTypeId}">
															<i class="mdi mdi-pencil lead"></i>
														</a>
														<a href="deleteAccountType?id=${i.accountTypeId}">
