				...
				<div class="content-wrapper">
					<div class="card">
						<div class="card-header"
									...
									<h4 class="text-white m-0">View Document</h4>
								</div>
						<div class="card-body">
								...
								<div class="col-12">
									<div class="table-responsive">
										<table id="order-listing" class="table">
											...
											<tbody>
												<c:forEach var="i" items="${searchDocumentList}"
													varStatus="j">
													<tr>
														<td>${j.count}</td>
														<td>${i.documentType}</td>
														<td>${i.documentDescription}</td>
														<td><a
															href="<%=request.getContextPath()%>/document/reqDocument/${i.documentFileName}" target="_blank"><img
																src="<%=request.getContextPath()%>/document/reqDocument/${i.documentFileName}"
																class="img-lg rounded" alt="${i.documentFileName}"></a></td>
														<td><a href="editDocument?id=${i.documentId}"> <i
																class="mdi mdi-pencil lead"></i>
														</a> <a href="deleteDocument?id=${i.documentId}"> <i
