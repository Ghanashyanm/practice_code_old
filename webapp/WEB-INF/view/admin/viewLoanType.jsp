...
<title>Admin | View Loan Type</title>
<!-- plugins:css -->
<link rel="stylesheet"
				...
				<div class="content-wrapper">
					<div class="card">
						<div class="card-header"
									...
									<h4 class="text-white m-0">View Loan Type</h4>
								</div>
						<div class="card-body">
								...
								<div class="col-12">
									<div class="table-responsive">
										<table id="order-listing" class="table">
											...
											<tbody>
											<c:forEach var="i" items="${searchLoanTypeList}" varStatus="j">
												<tr>
													<td>${j.count}</td>
													<td>${i.loanType}</td>
													<td>${i.loanDescription}</td>
													<td>
														<a href="editLoanType?id=${i.loanTypeId}">
															<i class="mdi mdi-pencil lead"></i>
														</a>
														<a href="deleteLoanType?id=${i.loanTypeId}">
